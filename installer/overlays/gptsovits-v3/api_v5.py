...
parser.add_argument(
    "-a", "--bind_addr", type=str, default="0.0.0.0", help="default: 127.0.0.1"
)
...
def change_weights(gpt_path, sovits_path):
...
async def tts_handle(req: dict):
    ...
    gpt_model_path = req.get("gpt_model_path")
    sovits_model_path = req.get("sovits_model_path")
    ...
    try:
        tts_pipeline = change_weights(gpt_model_path, sovits_model_path)
